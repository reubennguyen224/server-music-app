...
$idSong = $_GET['idSong'];
$querySong = "SELECT * FROM `Genre` WHERE Id = $idSong";
                        ...
                        <div class="col-lg-12 mb-10">
                            <div class="card shadow mb-9">
                                <div class="card-header py-4">
                                    <h6 class="m-1 font-weight-bolder text-primary text-center">Chỉnh sửa thể loại</h6>
                                </div>
                                <div class="card-body">
                                    <form class="user" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="tentl">Tên thể loại:</label>
                                            <input type="text" id="tentl" name="tentl" class="form-control" value="<?php echo $songInfo['Name'] ?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="description">Mô tả thể loại</label>
                                            <input type="text" id="description" name="description" class="form-control" value = "<?php echo $songInfo['Description'] ?>">
                                        </div>
...
<?php
    ...
    if (isset($_REQUEST['nhapvao'])) {
        ...
        $query1 = "UPDATE `Genre` SET `Name`='$tentl',`Description`='$description' WHERE `Id` = '$idSong'";
