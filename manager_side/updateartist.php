            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Thêm nghệ sĩ</h1>
                    </div>
                    <!--End of heading-->
<?php
...
$idSong = $_GET['idSong'];
$querySong = "SELECT * FROM `Artist` WHERE Id = $idSong";
                            ...
                            <div class="card shadow mb-9">
                                ...
                                <form class="user" method="post" enctype="multipart/form-data" action="themnghesi.php">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="tenns" name="tenns" class="form-control" value="<?php echo $songInfo['Name'] ?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="description">Giới thiệu nghệ sĩ</label>
                                            <input type="text" id="description" name="description" class="form-control" value="<?php echo $songInfo['Infomation'] ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="date" name="date" class="form-control" value="<?php echo $songInfo['DateCreated'] ?>">
                                        </div>
...
require_once('model.php');
    ...
    $date = strtotime($_POST['date']);
        ...
        $query1 = "UPDATE `Artist` SET `Name`='$tenns',`AvatarURI`='$avatarURI',`Introduction`='$description',`DateCreated`='$date' WHERE `Id` = '$idSong'";
