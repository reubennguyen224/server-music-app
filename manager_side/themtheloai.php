                                ...
                                <div class="card-body">
                                    <form class="user" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="tentl" name="tentl" class="form-control" placeholder="Nhạc Kịch">
                                        </div>

                                        <div class="form-group">
                                            <label for="description">Mô tả thể loại</label>
                                            <input type="text" id="description" name="description" class="form-control" placeholder="Thể loại âm nhạc biểu diễn cùng kịch nói">
                                        </div>
...
<?php
    ...
    if (isset($_REQUEST['nhapvao'])) {
        ...
        $query1 = "INSERT INTO `Genre`(`Name`, `Description`) VALUES ('$tentl','$description')";
        $ql = mysqli_query($dbconn, $query1);
