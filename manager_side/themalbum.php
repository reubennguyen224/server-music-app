            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Thêm album</h1>
                    </div>
                        ...
                        <div class="col-lg-12 mb-10">
                            <div class="card shadow mb-9">
                                <div class="card-header py-4">
                                    <h6 class="m-1 font-weight-bolder text-primary text-center">Thêm nghệ sĩ</h6>
                                </div>
                                <div class="card-body">
                                    <form class="user" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="tenal">Tên album:</label>
                                            <input type="text" id="tenal" name="tenal" class="form-control" placeholder="Tâm trạng tan chậm">
                                        </div>
...
require_once('model.php');
    ...
    $date = strtotime($_POST['date']);
        ...
        $query1 = "INSERT INTO `Album`(`ArtistId`, `Title`, `CoverURI`, `DateCreated`, `Type`) VALUES ('$idArtist','$tenal','$avatarURI','$date','$type')";
        $sql = mysqli_query($dbconn, $query1);

    $query2 = "SELECT * FROM `Album` ORDER BY `Id` DESC LIMIT 1";
    $sql2 = mysqli_query($dbconn, $query2);
    $row = mysqli_fetch_assoc($sql2);
    $idAlbum = $row['Id'];

    foreach ($_POST['song'] as $song) {
        $query3 = "INSERT INTO `SongAlbum`(`AlbumId`, `SongId`) VALUES ('$idAlbum','$song')";
