                        ...
                        <div class="col-lg-12 mb-10">
                            <div class="card shadow mb-9">
                                <div class="card-header py-4">
                                    <h6 class="m-1 font-weight-bolder text-primary text-center">Thêm bài hát</h6>
                                </div>
                                <div class="card-body">
                                    <form class="user" method="post" enctype="multipart/form-data" action="thembaihat.php">
                                        <div class="form-group row">
                                            <div class="col-sm-8 mb-3 mb-sm-0">
                                                <label for="tenbh">Tên bài hát:</label>
                                                <input type="text" id="tenbh" name="tenbh" class="form-control" placeholder="Giá như chưa bắt đầu">
                                            </div>
...
?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="links" name="links" class="form-control" placeholder="https:\\hoang2204.000webhost.com\gia-nhu-chua-bat-dau.mp3">
                                        </div>
...
<?php
    ...
    if (isset($_REQUEST['nhapvao'])) {
        ...
        $query1 = "INSERT INTO `Song`( `Title`, `SongURI`, `CoverURI`, `NumberOfStream`, `DateCreated`, `Views`) VALUES ('$tenbh','$linksong','$coverlink',0,'$date',0)";
        mysqli_query($dbconn, $query1);
        $query2 = "SELECT * FROM `Song` ORDER BY Song.Id DESC LIMIT 1";
        $sql1 = mysqli_query($dbconn, $query2);
        $row1 = mysqli_fetch_assoc($sql1);
        $idSong = $row1['Id'];

        $query3 = "INSERT INTO `SongArtist`(`ArtistId`, `SongId`) VALUES ('$idArtist','$idSong')";
        mysqli_query($dbconn, $query3);

        $query5 = "INSERT INTO `SongGenre`(`SongId`, `GenreId`) VALUES ('$idSong','$idGenre')";
