            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Danh sách album</h1>
                    </div>
...
$query = "SELECT Album.Id, Artist.Name, Album.Title, Album.DateCreated, Album.Type FROM Album JOIN Artist WHERE Album.ArtistId = Artist.Id";
...
while ($row = mysqli_fetch_assoc($sql)) {
    ...
    echo "<td>{$row['Type']}</td>";
    echo "<td><a class='btn btn-success' href='updatealbum.php?idSong=".$row['Id']."'> Chỉnh sửa</a></td>";
    echo '</tr>';
}
?>
